...
ChatClass.connect = function (params) {
    ...
    var msgProcessor, isSSL, connectOptions;
    var r = {
        status: "connecting",
    ...
    client.onMessageArrived = function (msgf) {
        return function (message) {
            msgf(message.payloadString, msgf);
        }
    } (msgProcessor);
    connectOptions = {
        onSuccess: function (me, channel) {
            return function () {
                me.status = "connected";
                client.subscribe(channel);
                if (me.onConnect !== undefined) {
